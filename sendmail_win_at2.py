...
@click.command()
@click.option('--filename', default='output_l2b_weekly_')
...
def sendmail_win_hb2(filename, email):
	...
	recipient_email = 'dan.zhang@touricoholidays.com'
	recipient_email1 = 'Felix.Huang@gta-travel.com'
	recipient_email2 = 'yun.liu@gta-travel.com'
	recipient_email3 = 'lwang@hotelbeds.com'
	recipient_email4 = 'kfu@hotelbeds.com'
	recipient_email5 = 'tianxian.yang@touricoholidays.com'
	recipient_email6 = 'jiarui.li@touricoholidays.com'
	body_text = 'FYI\n\n' + \
